...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Rio");
    case mBTC: return QString("mRio");
    case uBTC: return QString::fromUtf8("μRio");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("RioCoins"));
    case mBTC: return QString(QObject::tr("Milli-RioCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-RioCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
